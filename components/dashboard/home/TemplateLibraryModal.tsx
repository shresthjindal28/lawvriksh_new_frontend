...
const styles = {
  ...
  modalContainer: 'bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl',
  ...
  searchContainer: 'mt-3',
  searchWrapper: 'relative',
  searchIconWrapper: 'absolute left-3 top-1/2 -translate-y-1/2 text-gray-400',
  searchInput:
    'w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[--lv-accent-gold] focus:border-transparent',
  contentArea: 'flex-1 overflow-hidden',
  tableWrapper: 'h-full overflow-y-auto',
  table: 'w-full text-sm',
  tableHeader:
    'sticky top-0 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider',
  tableRow: 'border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors',
  tableRowSelected: 'bg-blue-50 border-blue-200',
  tableCell: 'px-4 py-3',
  titleCellContent: 'font-medium text-gray-900',
  tagsContainer: 'flex flex-wrap gap-1 mt-1',
  tag: 'px-2 py-0.5 text-xs bg-gray-100 text-gray-600 rounded',
  tagCountBadge: 'px-2 py-0.5 text-xs bg-gray-200 text-gray-600 rounded',
  noTags: 'text-xs text-gray-400',
  previewCell: 'text-right',
  previewButton: 'p-2 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600 inline-flex',
  mobilePreviewButton:
    'md:hidden p-2 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-gray-600',
  previewHeader: 'text-right',
  emptyMessage: 'px-4 py-8 text-center text-gray-500',
  errorMessage: 'px-4 py-4 text-center text-red-600',
  centeredMessage: 'flex items-center justify-center h-64',
  pagination: 'flex items-center justify-between p-4 border-t border-gray-100',
  ...
  continueButton:
    'px-4 py-2 text-sm font-medium bg-gray-900 text-white rounded-lg hover:bg-gray-800 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors',
  nextButton:
    'px-4 py-2 text-sm font-medium bg-gray-900 text-white rounded-lg hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors',
};
